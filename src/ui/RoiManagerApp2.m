classdef RoiManagerApp2 < handle   
    ...
    methods
        function obj = RoiManagerApp2(dataset, parentHandle)
            obj.dataset = dataset;
        ...
        function setTag(obj, str)
            assert(ischar(str), 'UI Tag must be type char!');
            obj.Tag = str;
        end
    ...
    methods (Access = private)
        ...
        function createUi(obj)
            ...
            btn = uibutton(uiGrid,...
                'Text', 'Export', 'ButtonPushedFcn', @obj.onPush_Export);
            btn.Layout.Row = 7; 
            btn.Layout.Column = 1;
